...
def _factor_ranking_row(record: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "net_sharpe": _to_float(performance.get("net_sharpe")),
        "gross_sharpe": _to_float(performance.get("gross_sharpe")),
        "max_drawdown": _to_float(performance.get("max_drawdown")),
        "total_return": _to_float(performance.get("total_return")),
        "net_total_return": _to_float(performance.get("net_total_return")),
        "gross_total_return": _to_float(performance.get("gross_total_return")),
        "turnover": _to_float(performance.get("turnover")),
        "total_transaction_cost": _to_float(performance.get("total_transaction_cost")),
