...
def memory_record_to_text(record: Mapping[str, Any]) -> str:
    ...
    parts = [
        ...
        f"gross_sharpe {performance.get('gross_sharpe')}",
        f"net_sharpe {performance.get('net_sharpe')}",
        f"max_drawdown {performance.get('max_drawdown')}",
        f"total_return {performance.get('total_return')}",
        f"gross_total_return {performance.get('gross_total_return')}",
        f"net_total_return {performance.get('net_total_return')}",
        f"turnover {performance.get('turnover')}",
        f"transaction_cost {performance.get('total_transaction_cost')}",
